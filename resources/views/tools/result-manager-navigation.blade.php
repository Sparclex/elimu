<router-link tag="h3" :to="{name: 'lens', params: {resourceName: 'results', lens: 'invalid'}}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
